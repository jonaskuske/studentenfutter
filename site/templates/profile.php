...
<main class="flex-grow pt-6 bg-angled-yellow">
  ...
  <div class="flex flex-col items-center">
    ...
    <a href="<?= url('profile/edit') ?>" class="mb-5 button bg-rose border-rose">Profil bearbeiten</a>
    <a href="<?= url('profile/edit-pw') ?>" class="mb-5 button border-rose">Passwort ändern</a>

    <a href="<?= url('logout') ?>" class="text-xs leading-tight underline text-blue">Abmelden</a>
  </div>
</main>